            ...
            <form method="post" action="">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td><input name="topic" type="text" id="topic" class="regular-text" placeholder="Ex: Benefícios da meditação mindfulness" required></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input name="audience" type="text" id="audience" class="regular-text" placeholder="Ex: Jovens adultos, estudantes universitários"></td>
                    </tr>
                    <tr>
                        <th scope="row"><label for="instructions">Instruções Extras</label></th>
                        <td><textarea name="instructions" id="instructions" rows="5" class="large-text" placeholder="Ex: Tom inspirador, usar lista de tópicos, max 500 palavras"></textarea></td>
                    </tr>
                </table>
                <p class="submit">
